<template>
    <div class="container-fluid">
        <ct-form  searchForm :loading="loading" @search="search">
            <form-item v-model="searchInfo.dates" type="dates" label="ID"></form-item>
            <form-item :list="typeList" defaultSelect v-model="searchInfo.Type" type="select" label="类型"></form-item>  
        </ct-form>
